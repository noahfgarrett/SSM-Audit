...
import { closeDrawer, renderAuditResult, renderComparisonResult, renderRules, renderUpload } from './ui/audit.js'
...
function go(screen){S.screen=screen;if(screen==='audit')renderAuditResult(go);else if(screen==='compare')renderComparisonResult(go);else if(screen==='rules')renderRules(go);else renderUpload(go);}
