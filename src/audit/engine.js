...
export const SSM_AUDIT_RULES=Object.freeze({
  ...
  icDiscipline:auditRule('metadata.ic-discipline','registry','metadata','I&C discipline is not the approved one','Instrumentation and controls rows use the approved controls discipline, and their UPN comes from the tag.'),
  ...
  staleDependencyProject:auditRule('dependency.project-not-needed','registry','dependencies','Dependency Project not needed','Dependency Project names another project when a dependency lives there. When every dependency is a tag in this registry, the field is stale.',{confidence:'strong'}),
