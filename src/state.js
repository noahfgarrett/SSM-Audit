...
export function resetSession(){
  S.session?.disposeReviewWorker?.();
  S.session={name:'',snapshot:null,result:null,error:'',auditedAt:0,status:null,sourceBytes:null,exportKind:'actionable',dimFilters:{discipline:[],milestone:[],upn:[],building:[]},dimOptionCache:null,filterOptionCache:null,hiddenSources:[],hiddenSeverities:[],hiddenCategories:[],hiddenRules:[],search:'',sort:'severity-desc',groupBy:'none',collapsedGroups:[],cursor:-1,panelOpen:false,panelSearch:'',selectedFindingId:'',scrollTop:0,actioned:null,actionedRev:0,hideActioned:false,changes:null,changesRev:0,excluded:null,excludedRev:0,modifySearch:'',modifyMilestone:'all',modifyDiscipline:'all',completedSearch:'',completedStep:'all',completedMatch:'all',completedDiscipline:'all',completedMilestone:'all',completedSort:'tag',modifyOpenRules:[],modifyClosedCats:[],modifyCountMode:'count',modifyScrollTop:0,modifyGroupsKey:'',modifyGroupsVal:null,dashBreakdownOpen:false,fullscreen:false,filteredCacheKey:'',filteredCacheRows:null,displayCacheKey:'',displayCacheRows:null,scopedCacheKey:'',scopedCache:null,rowIndex:null,headerIdSet:null,hierarchy:null,hierarchySearch:'',hierarchyBuilding:'all',hierarchyDiscipline:'all',hierarchySystem:'all',hierarchyFindingsOnly:false,hierarchyExpandedKeys:[],hierarchyInitialized:false,hierarchyScrollTop:0,hierarchyFullscreen:false,hierarchyCacheKey:'',hierarchyCacheRows:null,hierarchyFocusKey:'',selectedHierarchyNodeKey:''};
  Object.assign(S.session,{baselineSnapshot:null,baselineResult:null,draftResolved:new Set(),reviewedIds:new Set(),reviewHistory:[],reviewUndo:[],reviewDirty:false,reviewOwner:'',filterViews:[],references:{},milestoneMigration:{enabled:false,profile:null},actionPreviewOffset:0,reviewBusy:false,reviewSourceWorkbook:null,reviewRevision:'',pendingAutosave:null,autosaveFailed:false,milestoneReferences:[]});
}
