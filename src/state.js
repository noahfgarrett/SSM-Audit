...
export function resetSession(){
  ...
  Object.assign(S.session,{baselineSnapshot:null,baselineResult:null,draftResolved:new Set(),reviewedIds:new Set(),reviewHistory:[],reviewUndo:[],reviewDirty:false,reviewOwner:'',filterViews:[],references:{},milestoneMigration:{enabled:false,profile:null},actionPreviewOffset:0,reviewBusy:false,reviewSourceWorkbook:null});
}
